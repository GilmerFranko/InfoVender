...
<header>
  ...
  { ?>
    <ul id="userOptions" class="dropdown-content">
      ...
      <li><a href="<?php echo $extra->generateUrl('bets', 'completed_bets'); ?>">Apuestas</a></li>
      ...
      <?php if ($session->is_admod)
      {
        ...
        <?php } ?>
        <li><a href="<?php echo $extra->generateUrl('mod', 'active_bets'); ?>" title="Moderaci&oacute;n">Mod</a>
        </li>
        <li class="divider"></li>
      <?php
      }
      ...
      <?php if ($session->is_member) : ?>
        <div class="nav-wrapper">
          ...
          <div class="icons">
            ...
            <!-- Logo -->
            <a href="<?php echo gLink('bets/consoles.area'); ?>" class="left" style="font-weight: 600;">
