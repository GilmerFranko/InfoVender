    ...
    <div class="container">
        ...
        <div style="text-align:justify;" class="flow-text">
            <ul class="collapsible popout">
                ...
                <!-- DÉCIMA PREGUNTA -->
                <li>
                    <div class="collapsible-header"><i class="material-icons">filter_drama</i>¿Qué debo hacer si experimento problemas técnicos mientras apuesto en un juego?</div>
                    <div class="collapsible-body"><span>Si experimenta problemas técnicos mientras apuesta, como errores de carga o problemas de rendimiento, intente actualizar la página o cambiar de navegador. Si el problema persiste, comuníquese con nuestro equipo de soporte para obtener ayuda adicional.</span></div>
                </li>
            </ul>
        </div>
    </div>
