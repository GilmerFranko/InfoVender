<?php defined('ryctv_cursos') || exit;

/**
 *=======================================================
 *  ryctv_cursos Project
 *-------------------------------------------------------
...
<section id="memberCoin">
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col s12">
        <div class="card-panel green lighten-4 green-text text-darken-4 flow-text center-align">Tienes <span id="coinsCurrent"><?php echo $session->memberData['coins']; ?></span> cr&eacute;ditos

          <br />
          <p style="color:#fa0000" ;> <b> Los cr&eacute;ditos los consigues gratis desde nuestra <a href="https://ryctv_cursos.com/index.php?app=site&section=pages&name=entrarapp">aplicacion</a>, puedes conseguir hasta 300 cr&eacute;ditos gratis por dia.</b> ganas cr&eacute;ditos por comentar fotos, por darle me gusta a fotos, por cada vez que te den me gusta a tus comentarios, viendo videos, etc... ademas puedes canjear tus cr&eacute;ditos por dinero!.</b></p>


          Si no te llegan al instante <a href="https://ryctv_cursos.com/index.php?app=site&section=contact">ESCRÍBENOS</a> mencionando que hiciste la compra, revisaremos y los acreditaremos a tu cuenta. </b><b> Tambien puedes ganar cr&eacute;ditos gratis comentando las fotos y recibiendo me gustas en tus comentarios. </b></p>
          <?php
          if ($session->platform == 'app')
          {
            echo '<span><p style="color:#000000";><b>Gana cr&eacute;ditos gratis,  toca <a href="https://ryctv_cursos.com/index.php?app=site&section=pages&name=dinero">AQUI</a> y mira como</b></p></span>';
          }
          ?>
        </div>
      </div>
