            ...
            ?>
                    <tr id="BulkEmail_<?php echo $bulkemail['id']; ?>">
                        ...
                        <td>
                            ...
                            <a href="<?php echo Core::model('extra', 'core')->generateUrl('admin', 'bulkemails', 'action', array('do' => 'send', 'id' => $bulkemail['id'])); ?>" class="waves-effect waves-light btn modal-trigger green darken-2 tooltipped<?php if ($bulkemail['date_sent'] > 0)
                                                                                                                                                                                                                                                            {
                                                                                                                                                                                                                                                                echo ' disabled';
                                                                                                                                                                                                                                                            } ?>" data-position="top" data-tooltip="Enviar correo #<?php echo $bulkemail['id']; ?>" onclick="admin.bulkEmails.send('<?php echo $bulkemail['id']; ?>'); return false;">
